...
subroutine PMPIX_Get_notify_f08(origin_addr,origin_count,origin_datatype,target_rank,&
   ...
   implicit none
   interface
         subroutine ompix_get_notify_f(origin_addr,origin_count,origin_datatype,target_rank, &
                                       target_disp,target_count,target_datatype,win,notification_id,ierror) &
          BIND(C, name="ompix_get_notify_f")
         ...
         end subroutine ompix_get_notify_f
   end interface
   ...
   call ompix_get_notify_f(origin_addr,origin_count,origin_datatype%MPI_VAL,target_rank,&
                           target_disp,target_count,target_datatype%MPI_VAL,win%MPI_VAL,notification_id,c_ierror)
   if (present(ierror)) ierror = c_ierror

end subroutine PMPIX_Get_notify_f08
