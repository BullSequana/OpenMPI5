...
static mca_base_var_enum_value_t neighbor_allgatherv_algorithms[] = {
    {0, "ignore"},
    {0, NULL}
};
...
int ompi_coll_bullnbc_neighbor_allgatherv_check_forced_init (coll_bullnbc_force_algorithm_mca_param_indices_t *mca_param_indices)
{
  ...
  for( cnt = 0; NULL != neighbor_allgatherv_algorithms[cnt].string; cnt++ );
  mca_param_indices->algorithm_count = cnt;

  (void) mca_base_component_var_register(&mca_coll_bullnbc_component.super.collm_version,
                                         "ineighbor_allgatherv_algorithm_count",
                                         "Number of neighbor_allgatherv algorithms available",
  ...
  (void) mca_base_var_enum_create("coll_bullnbc_neighbor_allgatherv_algorithms", neighbor_allgatherv_algorithms, &new_enum);
  (void) mca_base_component_var_register(&mca_coll_bullnbc_component.super.collm_version,
                                         "ineighbor_allgatherv_algorithm",
                                         "Which neighbor_allgatherv algorithm is used.",
  ...
  mca_base_component_var_register(&mca_coll_bullnbc_component.super.collm_version,
                                  "ineighbor_allgatherv_algorithm_segmentsize",
                                  "Segment size in bytes used by default for ineighbor_allgatherv algorithms. Only has meaning if algorithm is forced and supports segmenting. 0 bytes means no segmentation.",
