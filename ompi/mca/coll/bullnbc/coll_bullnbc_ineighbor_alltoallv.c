...
static mca_base_var_enum_value_t neighbor_alltoallv_algorithms[] = {
    {0, "ignore"},
    {0, NULL}
};
...
int ompi_coll_bullnbc_neighbor_alltoallv_check_forced_init (coll_bullnbc_force_algorithm_mca_param_indices_t *mca_param_indices)
{
  ...
  (void) mca_base_component_var_register(&mca_coll_bullnbc_component.super.collm_version,
                                         "ineighbor_alltoallv_algorithm_count",
  ...
  (void) mca_base_var_enum_create("coll_bullnbc_neighbor_alltoallv_algorithms", neighbor_alltoallv_algorithms, &new_enum);
  (void) mca_base_component_var_register(&mca_coll_bullnbc_component.super.collm_version,
                                         "ineighbor_alltoallv_algorithm",
  ...
  mca_base_component_var_register(&mca_coll_bullnbc_component.super.collm_version,
                                  "ineighbor_alltoallv_algorithm_segmentsize",
                                  "Segment size in bytes used by default for ineighbor_alltoallv algorithms. Only has meaning if algorithm is forced and supports segmenting. 0 bytes means no segmentation.",
