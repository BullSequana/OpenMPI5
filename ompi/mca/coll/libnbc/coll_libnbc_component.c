                  ...
                  int *priority)
{
    ...
    *priority = libnbc_priority;
    ...
    if (OMPI_COMM_IS_INTER(comm)) {
        ...
        module->super.coll_igatherw = ompi_coll_libnbc_igatherw_inter;
        ...
        module->super.coll_gatherw_init = ompi_coll_libnbc_gatherw_inter_init;
        ...
        module->super.coll_igatherw = ompi_coll_libnbc_igatherw;
        ...
        module->super.coll_gatherw_init = ompi_coll_libnbc_gatherw_init;
